					...
					<div class="col-md-12">
						<div class="coupon-accordion">
							...
							<h3>Returning customer?
								<span id="showlogin" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Click here to login</span>
							</h3>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="checkout-form-list create-acc">	
											<input id="cbox"  data-toggle="toggle"  type="checkbox" />
								...
								<div class="different-address">
										<div class="ship-different-title">
											<h3>
												...
												<input id="ship-box"  data-toggle="toggle"  type="checkbox" />
											</h3>
										</div>
